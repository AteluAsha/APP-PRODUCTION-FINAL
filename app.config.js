...
module.exports = {
  expo: {
    ...
    ios: {
      ...
      // iOS 1.2.4 (46): Anua streaming chat + Device ID privacy manifest.
      // Follows 1.2.3 (45) already on App Store Connect.
      buildNumber: "46",
      privacyManifests: {
    ...
    android: {
      ...
      // User-facing 1.2.4. Production AAB versionCode 44 (appVersionSource: local).
      versionCode: 44,
