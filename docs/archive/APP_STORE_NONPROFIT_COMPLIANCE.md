...
**Scholarship Audit:** Scholarship requests are logged to Firestore `scholarship_requests` (userId, reason, timestamp) for 501(c)(3) audit. Access is granted immediately per gift model.
