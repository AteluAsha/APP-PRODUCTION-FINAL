...
When aligning with "3 days ago" or production-approved designs, use this doc and the referenced ANUA\_\* plan files; restore only via explicit `style`, do not change intended UX or copy.
