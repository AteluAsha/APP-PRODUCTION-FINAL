...
export const APP_STORE_URLS = {
  ios: "https://apps.apple.com/app/id6760920862",
  android:
    "https://play.google.com/store/apps/details?id=com.sevenchakras.SevenChakras",
} as const
...
// Awakening Soul hero site – archetype quiz (waiting room + ChakraHub)
...
export const SHARE_MESSAGE = `Join me on Awakening Soul — 7 Chakras: The Map from Self to Soul. ✨`
