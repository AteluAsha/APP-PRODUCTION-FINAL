            ...
            <SafeAreaView className="flex-1 bg-black">
                ...
                >
                    ...
                    <ScrollView className="flex-1 px-6 py-6" showsVerticalScrollIndicator={false}>
                        {/* Info Section */}
                        <View className="mb-6">
                            <AppText font="instrument-regular" size="base" className="text-white leading-6 mb-4">
                                Soul School is a Public Benefit Non Profit committed to making spiritual growth accessible to all.
                            </AppText>
                            <AppText font="instrument-regular" size="base" className="text-gray-300 leading-6 mb-4">
                                We offer free scholarships to those who need them. This is not a barter or exchange—it's a gift of access.
                            </AppText>
                            <AppText font="instrument-medium" size="base" className="text-white mb-2">
                                Why do you need a scholarship?
                            </AppText>
                            <AppText font="instrument-regular" size="sm" className="text-gray-400 mb-4">
                                Share your reason below. Your response helps us understand how to best serve our community.
                            </AppText>
                        </View>
                    ...
                    <View className="border-t border-gray-800 bg-black p-6">
                        ...
                        <AppText font="instrument-regular" size="xs" className="text-gray-500 mt-3 text-center">
                            Next, you'll see connection options—not a barter, but ways to stay connected with our community.
                        </AppText>
                    </View>
                </KeyboardAvoidingView>
            </SafeAreaView>
