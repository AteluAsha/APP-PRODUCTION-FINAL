            ...
            <Modal visible={visible} animationType="slide" onRequestClose={handleClose}>
                <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
                    <View style={styles.loadingContainer}>
                        ...
                        <AppText font="instrument-regular" size="base" style={styles.loadingText}>
            ...
            <Modal visible={visible} animationType="slide" onRequestClose={handleClose}>
                <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
                    <View style={styles.permissionContainer}>
                        ...
                        <AppText font="instrument-bold" size="xl" style={styles.permissionTitle}>
                            Camera Permission Required
                        </AppText>
                        <AppText font="instrument-regular" size="base" style={styles.permissionText}>
                        ...
                        >
                            <AppText font="instrument-bold" size="lg" style={styles.permissionButtonText}>
                                Grant Permission
                            </AppText>
                        </Pressable>
                ...
                <View style={styles.cameraContainer}>
                    {!recordedVideoUri ? (
                        <CameraView
                            ref={cameraRef}
                            style={styles.camera}
                            facing={CameraType.front} // Front-facing camera for selfie videos
                        >
                            {/* Recording Indicator */}
                            {isRecording && (
                                <View style={styles.recordingIndicator}>
                                    <View style={styles.recordingDot} />
                                    <AppText font="instrument-regular" size="sm" style={styles.recordingText}>
                                        Recording...
                                    </AppText>
                                </View>
                            )}
                            ...
                            {!isRecording && (
                                <View style={styles.instructionsContainer}>
                                    <AppText font="instrument-regular" size="sm" style={styles.instructions}>
                        ...
                        <View style={styles.previewContainer}>
                            <AppText font="instrument-regular" size="base" style={styles.previewText}>
                ...
                <View style={styles.controlsContainer}>
                    {!recordedVideoUri ? (
                        <>
                            ...
                            {/* Instructions */}
                            <AppText font="instrument-regular" size="sm" style={styles.instructionText}>
                                {isRecording
                        ...
                        <>
                            ...
                            <View style={styles.linkOptionContainer}>
                                <AppText font="instrument-regular" size="base" style={styles.linkOptionMessage}>
                                    Being Vulnerable is a Superpower.
                                </AppText>
                                <AppText font="instrument-regular" size="sm" style={styles.linkOptionSubtext}>
                                    If you feel like sharing this experience, here's the app link to add to your post.
                                </AppText>
                                ...
                                >
                                    ...
                                    <AppText font="instrument-regular" size="sm" style={styles.copyLinkText}>
                                        Copy App Link
                                    </AppText>
                                </Pressable>
                                ...
                                >
                                    <AppText font="instrument-regular" size="sm" style={styles.doneButtonText}>
                                        Done
                                    </AppText>
                                </Pressable>
                            </View>
                        ...
                        <>
                            ...
                            <View style={styles.actionButtons}>
                                ...
                                >
                                    ...
                                    <AppText font="instrument-regular" size="sm" style={styles.retakeButtonText}>
                                        Retake
                                    </AppText>
                                </Pressable>
                                ...
                                >
                                    {isSharing ? (
                                        ...
                                        <>
                                            ...
                                            <AppText font="instrument-regular" size="sm" style={styles.shareButtonText}>
                                                Share
                                            </AppText>
                                        </>
                                    )}
