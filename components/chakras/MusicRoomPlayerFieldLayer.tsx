...
import {
    getMusicRoomFieldVariant,
    type MusicRoomFieldVariant,
} from '@/constants/musicRoomPlayerFields'
...
export function MusicRoomPlayerFieldLayer({
    ...
    const variant: MusicRoomFieldVariant = getMusicRoomFieldVariant(
        trackKind,
        dayIndex,
    )
    ...
    useEffect(() => {
        drift.value = withRepeat(
            withTiming(variant.driftScale, {
                duration: variant.driftDurationMs,
                easing: Easing.inOut(Easing.ease),
            }),
            -1,
            true,
        )
    }, [drift, variant.driftDurationMs, variant.driftScale])
        ...
        <View pointerEvents="none" style={StyleSheet.absoluteFill}>
            ...
            <View
                style={{
                    ...
                    opacity: variant.vignetteOpacity,
                }}
            >
                <LightSwirl
                    color={color}
                    size={swirlSize}
                    duration={variant.primarySwirlDuration}
                ...
                <LightSwirl
                    color={color}
                    size={swirlSize * 0.78}
                    duration={variant.secondarySwirlDuration}
                    reverse
                ...
                <LightSwirl
                    color="#E8C98C"
                    size={swirlSize * 0.5}
                    duration={variant.goldSwirlDuration}
