 ...
 */
export const getTimeUntilNextRequest = (service: keyof typeof RATE_LIMITS): number => {
    const config = RATE_LIMITS[service]
 ...
 */
export const waitForRateLimit = async (service: keyof typeof RATE_LIMITS): Promise<void> => {
